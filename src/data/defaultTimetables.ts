...
export const TIMETABLE_DINH_VAN_PHU_SLOTS: Record<string, Record<string, string>> = {
  ...
  "Thứ Hai_Chiều_1": { "1.1": "TNXH (Cang)", "1.2": "TV", "2": "AN (Vũ)", "3": "TA (Quyên)", "4.1": "HĐTN (ÂN)", "4.2": "TH (Thảo)", "5": "LS-ĐL" },
  "Thứ Hai_Chiều_2": { "1.1": "AN (Vũ)", "1.2": "TNXH (Cang)", "2": "TCTV", "3": "GDTC (ÂN)", "4.1": "TH (Thảo)", "4.2": "TA (Quyên)", "5": "KH (Ngân)" },
  "Thứ Hai_Chiều_3": { "1.1": "TV", "1.2": "AN (Vũ)", "2": "TNXH (Cang)", "3": "TH (Thảo)", "4.1": "KH (Ngân)", "4.2": "GDTC (ÂN)", "5": "ĐĐ" },
  ...
  "Thứ Ba_Chiều_2": { "1.1": "TV", "1.2": "TNXH (Cang)", "2": "TCTV", "3": "T", "4.1": "AN (Vũ)", "4.2": "LS-ĐL", "5": "GDTC (ÂN)" },
  "Thứ Ba_Chiều_3": { "1.1": "T", "1.2": "TCTV", "2": "TNXH (Cang)", "3": "ĐĐ", "4.1": "GDTC (ÂN)", "4.2": "ĐĐ (Hoài)", "5": "LS-ĐL" },
  ...
  "Thứ Tư_Chiều_2": { "1.1": "TCTV", "1.2": "BDAN (Vũ)", "2": "TV", "3": "TA (Quyên)", "4.1": "LS-ĐL (Cang)", "4.2": "GDTC (ÂN)", "5": "TV" },
  "Thứ Tư_Chiều_3": { "1.1": "TCTV", "1.2": "TCTV", "2": "TV", "3": "HĐTN (ÂN)", "4.1": "TA (Quyên)", "4.2": "BDAN (Vũ)", "5": "TV" },
...
export const DEFAULT_MASTER_TIMETABLE: MasterTimetable = {
  ...
  version: "2026_dinhvanphu_official_sync_v1",
...
export function isSlotMatchingTeacherOrSubject(
  ...
  if (lowerName.includes("ân")) {
    return lowerCell.includes("(ân)") || lowerCell.includes("(an)") || lowerCell.includes("ân");
  }
